const programs = [
  ...
  },
  {
    ...
    description:
      "The AI Space Art Challenge aims to explore the intersection of artificial intelligence and artistic expression by generating unique and imaginative space-themed artworks using AI tools.",
