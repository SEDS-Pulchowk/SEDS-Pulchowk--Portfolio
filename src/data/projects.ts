const projects = [
  ...
  },
  {
    ...
    description:
      "Our SEDS team also have successfully launched cansat as the demonstration of the cansat launching and working process from top of ICTC building at final fay of LOCUS program.",
